                            ...
                            <form action="{{route('subcategory.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sub Category" name="name">
                                        @error('name')
                                            ...
                                            @foreach($data as $categories)
                                                   ...
                                                   <tr>
                                                       ...
                                                       <a class="btn btn-info"
                                                               href="{{route('subcategory.edit', $categories->id)}}">Edit</a>
                                                               <form method="POST" action="{{ route('subcategory.destroy', $categories->id) }}">
                                                                   @csrf
