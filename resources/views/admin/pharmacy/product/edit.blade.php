        ...
        <div class="main-content">
            <section class="section">
                <div class="section-body">
                    ...
                    <form id="add_student" action="{{ route('pharmacyProduct.update', $data->id) }}" method="POST"
                                                ...
                                                <select name="category_id" id="category-dropdown" class="form-control"
                                                    ...
                                                    @foreach ($category as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ $data->product->category_id == $country->id ? 'selected' : '' }} disabled>
                                                            {{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('category_id')
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="subcategory_id" id="subcategory-dropdown"
                                                    ...
                                                    @foreach ($subcategory as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ $data->product->subcategory_id == $country->id ? 'selected' : '' }} disabled>
                                                            {{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="product_id" id="product-dropdown" class="form-control">
                                                    ...
                                                    @foreach ($product as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ $data->product_id == $country->id ? 'selected' : '' }} disabled>
                                                            {{ $country->product_name }}</option>
                                                    @endforeach
                                                </select>
                                                @if($data->product_id)
