                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('change_password')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password" type="password" class="form-control pwstrength" data-indicator="pwindicator" placeholder="Password" name="password" tabindex="2" >
                                    @error('password') <span class="text-danger">{{$errors->first('password')}}</span> @enderror
                                </div>
                                <div class="form-group">
                                    <label for="password-confirm">Confirm Password</label>
                                    <input id="password-confirm" type="password" class="form-control" name="confirmed" placeholder="Password Confirmation" tabindex="2" >
